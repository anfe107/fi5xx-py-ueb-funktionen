# Testfallkatalog A2 — sum_list
#
# | Nr. | Eingabe        | Erwartete Ausgabe | Begründung                                  |
# |-----|----------------|-------------------|---------------------------------------------|
# | 1   | [1, 2, 3]      | 6                 | Normalfall: kurze Liste                     |
# | 2   | []             | 0                 | Randfall: leere Liste, Default-Rückgabe     |
# | 3   | [42]           | 42                | Randfall: einelementige Liste               |
# | 4   | [-1, 1, -2, 2] | 0                 | Sonderfall: Werte heben sich auf            |
# | 5   | [-5, -10, -3]  | -18               | Normalfall: nur negative Zahlen             |
