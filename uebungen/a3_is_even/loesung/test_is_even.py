# Testfallkatalog A6 — is_even
#
# | Nr. | Eingabe | Erwartete Ausgabe | Begründung                              |
# |-----|---------|-------------------|-----------------------------------------|
# | 1   | 4       | True              | Normalfall: positive gerade Zahl        |
# | 2   | 7       | False             | Normalfall: positive ungerade Zahl      |
# | 3   | 0       | True              | Randfall: Null gilt als gerade          |
# | 4   | -2      | True              | Sonderfall: negative gerade Zahl        |
# | 5   | -3      | False             | Sonderfall: negative ungerade Zahl      |
